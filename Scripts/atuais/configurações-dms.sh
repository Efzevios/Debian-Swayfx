...
echo "==================================================="
echo "  Importador de Setup do DankMaterialShell (DMS)   "
echo "==================================================="
...
if [ -f "$CONFIG_FILE" ]; then
    echo "[*] Criando backup do arquivo atual em: $BACKUP_FILE"
    cp "$CONFIG_FILE" "$BACKUP_FILE"
fi

echo "[*] Injetando todas as configurações otimizadas..."
...
cat << 'EOF' > "$CONFIG_FILE"
{
  ...
  "osdPosition": 5,
  "osdVolumeEnabled": false,
  "osdMediaVolumeEnabled": false,
  ...
  "systemMonitorLayoutMode": "center",
  "systemMonitorX": -1,
  "systemMonitorY": -1,
...
# Recarrega o DMS
echo "[*] Reiniciando os processos do DMS..."
if command -v dms &> /dev/null; then
    dms reload 2>/dev/null
    echo "[+] Concluído! O setup já está em uso."
else
    echo "[+] Concluído! Saia da sessão e volte para ver as mudanças."
fi
echo "==================================================="
